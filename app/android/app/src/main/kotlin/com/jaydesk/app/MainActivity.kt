...
import com.jaydesk.app.service.JayDeskService
import com.jaydesk.app.runtime.LinuxRuntime
import com.jaydesk.app.runtime.ChrootRuntime
import com.jaydesk.app.runtime.RootShell
import com.jaydesk.app.runtime.AndroidAppBridge
import com.jaydesk.app.runtime.DesktopIntegration
import com.jaydesk.app.view.AndroidSurfaceViewFactory
import com.jaydesk.app.x11.X11ServerService
...
class MainActivity : FlutterActivity() {
    ...
    companion object {
        private const val CHANNEL = "com.jaydesk.core"
    ...
    private fun handleHomeLaunch(homeIntent: Intent) {
        ...
        thread(name = "home-launch") {
            ...
            runOnUiThread {
                startActivity(Intent(this, com.jaydesk.app.view.DesktopActivity::class.java).apply {
    ...
    private fun runAutoChrootSetup() {
        thread(name = "auto-chroot-setup") {
            try {
                ...
                runOnUiThread {
                    val intent = Intent(this@MainActivity, com.jaydesk.app.view.DesktopActivity::class.java).apply {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        flutterEngine
            ...
            .registry
            .registerViewFactory("jaydesk-surface", AndroidSurfaceViewFactory())
    ...
    private fun startForegroundService() {
        val intent = Intent(this, JayDeskService::class.java)
    ...
    private fun requestDefaultLauncher() {
        if (isDefaultLauncher()) {
            Toast.makeText(this, "JayDesk is already the default launcher", Toast.LENGTH_SHORT).show()
            return
        }
