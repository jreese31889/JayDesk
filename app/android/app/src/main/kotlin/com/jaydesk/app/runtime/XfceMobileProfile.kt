...
/** Installs JayDesk's touch-friendly Ubuntu-inspired XFCE defaults once per home. */
object XfceMobileProfile {
    private const val TAG = "XfceMobileProfile"
    private const val PROFILE_MARKER = ".jaydesk-xfce-mobile-v5"
    private const val WALLPAPER_ASSET = "jaydesk/ubuntu-touch-wallpaper.jpg"
    ...
    fun install(
        ...
        return try {
            ...
            writeLauncher(
                File(panelDir, "launcher-21/jaydesk-terminal.desktop"),
                name = "Terminal",
            ...
            writeLauncher(
                File(panelDir, "launcher-22/jaydesk-files.desktop"),
                name = "Files",
            ...
            writeLauncher(
                File(panelDir, "launcher-23/jaydesk-browser.desktop"),
                name = "Web Browser",
    ...
    private fun installPanelCss(homeDir: File) {
        ...
        val startMarker = "/* JayDesk mobile panel start */"
        val endMarker = "/* JayDesk mobile panel end */"
        val managedBlock = """
            $startMarker
          ...
          <property name="plugins" type="empty">
            ...
            <property name="plugin-21" type="string" value="launcher">
              <property name="items" type="array">
                <value type="string" value="jaydesk-terminal.desktop"/>
              </property>
            </property>
            <property name="plugin-22" type="string" value="launcher">
              <property name="items" type="array">
                <value type="string" value="jaydesk-files.desktop"/>
              </property>
            </property>
            <property name="plugin-23" type="string" value="launcher">
              <property name="items" type="array">
                <value type="string" value="jaydesk-browser.desktop"/>
              </property>
            </property>
